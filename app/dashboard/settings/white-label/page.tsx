  ...
  return (
    <div style={{ maxWidth: 700, margin: '0 auto' }}>
      <div style={{ marginBottom: 32 }}>
        <h1 style={{ fontSize: 22, fontWeight: 700, color: '#e8ecf2', margin: '0 0 4px' }}>White Label</h1>
        <p style={{ fontSize: 13, color: '#556880' }}>
      ...
      {!isAgency && (
        <div style={{
          ...
          <p style={{ color: '#556880', fontSize: 13, marginBottom: 16 }}>
      ...
      <div style={{ opacity: isAgency ? 1 : 0.4, pointerEvents: isAgency ? 'auto' : 'none' }}>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontSize: 15, fontWeight: 600, color: '#e8ecf2' }}>Enable White Label</div>
            <div style={{ fontSize: 12, color: '#556880', marginTop: 2 }}>Replace all 0nCore branding with yours</div>
          </div>
          <button onClick={() => update('enabled', !config.enabled)} style={{
            width: 48, height: 26, borderRadius: 13, border: 'none', cursor: 'pointer',
            background: config.enabled ? '#2dd4bf' : '#1c2b42',
        ...
        <div style={{
          ...
          <h3 style={{ fontSize: 11, fontWeight: 700, color: '#2dd4bf', marginBottom: 16, textTransform: 'uppercase', letterSpacing: '0.06em' }}>Branding</h3>
        ...
        <div style={{
          ...
          <h3 style={{ fontSize: 11, fontWeight: 700, color: '#2dd4bf', marginBottom: 16, textTransform: 'uppercase', letterSpacing: '0.06em' }}>Custom Domain</h3>
          <div>
            ...
            <input value={config.customDomain} onChange={e => update('customDomain', e.target.value)}
              ...
              onFocus={e => e.target.style.borderColor = '#2dd4bf'}
              onBlur={e => e.target.style.borderColor = '#1c2b42'} />
            <p style={{ fontSize: 11, color: '#556880', marginTop: 6 }}>
              Point a CNAME record to <code style={{ background: '#0e1825', padding: '2px 6px', borderRadius: 4 }}>cname.vercel-dns.com</code>
            </p>
          </div>
        </div>
        ...
        <div style={{
          ...
          <h3 style={{ fontSize: 11, fontWeight: 700, color: '#2dd4bf', marginBottom: 16, textTransform: 'uppercase', letterSpacing: '0.06em' }}>Email</h3>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            <div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              <button onClick={() => update('hideFooterBranding', !config.hideFooterBranding)} style={{
                ...
                background: config.hideFooterBranding ? '#2dd4bf' : '#1c2b42',
                position: 'relative', transition: 'background 0.2s',
              }}>
                <div style={{
              ...
              <span style={{ fontSize: 13, color: '#8b9ab5' }}>Hide "Powered by 0nMCP" footer</span>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <h3 style={{ fontSize: 11, fontWeight: 700, color: '#2dd4bf', marginBottom: 16, textTransform: 'uppercase', letterSpacing: '0.06em' }}>Preview</h3>
          <div style={{
            background: '#0c1220', borderRadius: 10, padding: '20px',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
              ...
              <span style={{ fontSize: 14, fontWeight: 700, color: '#e8ecf2' }}>{config.appName}</span>
            </div>
            <div style={{ display: 'flex', gap: 8 }}>
              ...
              <div style={{ width: 50, height: 8, borderRadius: 4, background: '#1c2b42' }} />
            </div>
            {!config.hideFooterBranding && (
              <p style={{ fontSize: 9, color: '#556880', marginTop: 12 }}>Powered by 0nMCP</p>
            )}
          </div>
        </div>
        ...
        <button onClick={handleSave} disabled={saving} style={{
          ...
          background: saving ? '#1c2b42' : 'linear-gradient(135deg, #2dd4bf, #14b8a6)',
          color: saving ? '#556880' : '#0c1220',
...
const inputStyle: React.CSSProperties = {
  ...
  borderRadius: 8, color: '#e8ecf2', fontSize: 14, outline: 'none',
