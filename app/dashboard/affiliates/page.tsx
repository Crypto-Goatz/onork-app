  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto' }}>
      <div style={{ marginBottom: 32 }}>
        <h1 style={{ fontSize: 22, fontWeight: 700, color: '#e8ecf2', margin: '0 0 4px' }}>Affiliate Program</h1>
        <p style={{ fontSize: 13, color: '#556880' }}>Earn 30% recurring commission for every customer you refer to 0nCore.</p>
      </div>

      {/* Stats Cards */}
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 12, marginBottom: 24 }}>
        {[
          { label: 'Total Referrals', value: stats.totalReferrals, color: '#2dd4bf' },
          ...
          <div key={s.label} style={{
            ...
            <div style={{ fontSize: 11, color: '#556880', marginTop: 4 }}>{s.label}</div>
          </div>
        ))}
      </div>
      ...
      <div style={{
        ...
        <h3 style={{ fontSize: 15, fontWeight: 700, color: '#e8ecf2', marginBottom: 12 }}>Your Referral Link</h3>
        <div style={{ display: 'flex', gap: 10 }}>
          <input
            ...
            style={{
              ...
              borderRadius: 10, color: '#8b9ab5', fontSize: 14,
            }}
          />
        ...
        <p style={{ fontSize: 12, color: '#556880', marginTop: 10 }}>
      ...
      <div style={{
        ...
        <h3 style={{ fontSize: 15, fontWeight: 700, color: '#e8ecf2', marginBottom: 16 }}>Commission Structure</h3>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 12 }}>
          {[
            { plan: 'Starter', price: '$80/mo', commission: '$24/mo', color: '#2dd4bf' },
            ...
            <div key={p.plan} style={{
              ...
              <div style={{ fontSize: 13, fontWeight: 600, color: '#e8ecf2', marginBottom: 4 }}>{p.plan}</div>
              <div style={{ fontSize: 11, color: '#556880', marginBottom: 8 }}>{p.price}</div>
              <div style={{ fontSize: 20, fontWeight: 800, color: p.color }}>{p.commission}</div>
              <div style={{ fontSize: 10, color: '#556880', marginTop: 2 }}>recurring</div>
            </div>
          ))}
        </div>
        <p style={{ fontSize: 12, color: '#556880', marginTop: 14, textAlign: 'center' }}>
      ...
      <div style={{
        ...
        <h3 style={{ fontSize: 15, fontWeight: 700, color: '#e8ecf2', marginBottom: 16 }}>Marketing Materials</h3>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
          {[
            ...
            >
              ...
              <div>
                <div style={{ fontSize: 13, fontWeight: 600, color: '#e8ecf2' }}>{m.name}</div>
                <div style={{ fontSize: 11, color: '#556880' }}>{m.desc}</div>
              </div>
            </div>
          ))}
        </div>
      ...
      <div style={{
        ...
        <h3 style={{ fontSize: 15, fontWeight: 700, color: '#2dd4bf', marginBottom: 8 }}>Payouts</h3>
