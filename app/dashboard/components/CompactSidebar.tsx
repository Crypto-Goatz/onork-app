    ...
    items: [
      {
        ...
        children: [
          { name: 'Browse Apps', href: '/dashboard/marketplace' },
          { name: 'My Apps', href: '/dashboard/marketplace/my-apps' },
          { name: 'Publish App', href: '/dashboard/marketplace/publish' },
          { name: 'Vendor Dashboard', href: '/dashboard/marketplace/vendor' },
        ],
      },
      {
        name: 'Chat (Jaxx)',
