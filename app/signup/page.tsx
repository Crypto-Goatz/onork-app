      ...
      <div className="w-full max-w-sm animate-fade-in relative z-10">
        ...
        <div className="bg-core-card border border-core-border rounded-xl p-6 space-y-4">
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <button onClick={handleSlackLogin} className="w-full flex items-center justify-center gap-2.5 bg-[#111] border border-[#222] rounded-lg px-4 py-3 text-sm font-semibold text-[#e0e0e0] hover:border-[#611f69] hover:bg-[rgba(97,31,105,0.06)] transition-all cursor-pointer">
              <svg width="18" height="18" viewBox="0 0 24 24">
