// PRESERVED, NOT DELETED. This was /hub until 2026-08-19, when Mike ruled that
// the Hub becomes the customer landing and the vault becomes something you find
// rather than a door you must pass. The reasoning: the invite email sends cold
// visitors to /hub, and a power button does not explain itself to someone who
// has never seen the product.
//
// Every behaviour here still matters and still runs — it is mounted at
// /account/security. In particular the IKY device challenge continues to guard
// key display, which is the part that must not be lost in a re-landing.
'use client'
