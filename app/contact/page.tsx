      ...
      <section className="max-w-5xl mx-auto px-6 pb-16">
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            {/* Slack Community */}
            <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] p-6 hover:border-[#14b8a6]/20 transition-colors">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-[#14b8a6]/10 flex items-center justify-center shrink-0">
                  <svg className="w-5 h-5 text-[#14b8a6]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.75}>
                ...
                <div>
                  ...
                  <a href="https://0nmcp.com/community" target="_blank" rel="noopener noreferrer" className="text-[13px] font-semibold text-[#14b8a6] no-underline hover:underline">
                    Join on 0nmcp.com
                  </a>
                </div>
              </div>
