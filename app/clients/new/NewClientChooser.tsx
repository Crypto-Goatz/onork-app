/**
 * The creation chooser: $5 bare, or $10 born with the AI layer.
 *
 * MOUNTED AT TWO PATHS, like the management page — and here the second mount is
 * load-bearing for a subtler reason. Both hosts route /clients/* under /crm, so
 * without a static /crm/clients/new the word "new" was swallowed by the
 * [locationId] segment and this chooser rendered as "that client is not on your
 * account". A static segment outranks a dynamic one; existing is the fix.
 *
...
export default function NewClientChooser() {
