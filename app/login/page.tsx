        ...
        <div className="login-left-inner">
          ...
          <div className="glass-login-card">
            ...
            <div className="flex flex-col gap-[6px] mb-[18px]">
              ...
              <button type="button" onClick={() => handleOAuth('linkedin_oidc')} className="oauth-btn">
                ...
                <div className="flex flex-col items-start">
                  <span className="text-[13px] font-semibold">Continue with LinkedIn</span>
                  <span className="text-[10px] text-white/30 font-normal">AI social posting, lead intelligence</span>
                </div>
              </button>
              <button type="button" onClick={handleSlackLogin} className="oauth-btn">
                <svg width="18" height="18" viewBox="0 0 24 24" className="shrink-0">
                ...
                <div className="flex flex-col items-start">
                  <span className="text-[13px] font-semibold">Continue with Slack</span>
            ...
            <form onSubmit={handleLogin}>
              ...
              <div className="mb-2">
                ...
                <input id="login-password" name="password" type="password" autoComplete="current-password" value={password} onChange={e => setPassword(e.target.value)} required placeholder="Enter your password" className="login-input" />
              </div>
              <div className="mb-5 text-right">
                <Link href="/forgot-password" className="text-[11px] text-white/30 hover:text-[#7ed957] no-underline transition-colors">
                  Forgot password?
                </Link>
              </div>
            ...
            <div className="text-center mt-4 pt-4 border-t border-white/[0.05]">
              <button type="button" onClick={() => setShowModal(true)} className="login-request-btn">
                Request Access
              </button>
            </div>
          </div>
