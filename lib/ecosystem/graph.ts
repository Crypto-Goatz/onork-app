...
export const NODES: EcoNode[] = [
  ...
  // ── 3 · Web surfaces that consume the runtime · 4 · Clients on the person's own machine ──────────────────────────────
  ...
  { id: 'extension', label: 'Chrome Extension', kind: 'surface', layer: 4, status: 'live',
    repo: '0n-extension',
  ...
  { id: 'cli', label: 'CLI · Claude Desktop · Cursor', kind: 'surface', layer: 4, status: 'live',
    repo: '0n3',
  ...
  { id: 'web0n', label: 'web0n', kind: 'surface', layer: 4, status: 'building',
  ...
  { id: 'db_task', label: 'Postgres + Firestore · 0nTask', kind: 'data', layer: 5, status: 'live',
  ...
  { id: 'stripe', label: 'Stripe', kind: 'external', layer: 6, status: 'partial',
  ...
  { id: 'slack', label: 'Slack', kind: 'external', layer: 6, status: 'partial',
    blurb: 'Per-workspace bot tokens.' },
  { id: 'github', label: 'GitHub', kind: 'external', layer: 6, status: 'partial',
    blurb: 'Repos, issues, pull requests.' },
  { id: 'models', label: 'AI of your choice', kind: 'external', layer: 6, status: 'live',
  ...
  // ── 6 · Who builds it ──────────────────────────────────────────────────
  { id: 'mike', label: 'Operator', kind: 'operator', layer: 7, status: 'live',
    blurb: 'One person, directing the whole system.' },
  { id: 'cece', label: 'Cece', kind: 'build', layer: 7, status: 'live',
    blurb: 'Claude Code. Ships, probes, refuses to report what it has not proven.' },
  { id: 'dex', label: 'Dex', kind: 'build', layer: 7, status: 'live',
    blurb: 'Desktop Claude. Holds the plan between sessions; has the browser.' },
  { id: 'gemini', label: 'Gemini', kind: 'build', layer: 7, status: 'live',
    blurb: 'Gemini CLI. Third peer in the room.' },
  { id: 'bridge', label: 'The Bridge', kind: 'build', layer: 7, status: 'live',
    repo: '0n-bridge',
