...
export const BRAIN_REGISTRY: RegistryEntry[] = [
  ...
  // ── AI claims to refactor (currently red) ──────────────────────────
  {
    slug: 'service_packager',
    display_name: 'Service Packager',
    category: 'ai',
    handler_paths: ['app/api/service-packager/generate/route.ts'],
    required_imports: ['@/lib/brain'],
    prohibited_imports: ['@anthropic-ai/sdk'],
    required_calls: ['think(', 'record('],
  ...
  },
  {
    ...
    display_name: '0nExec',
    category: 'ai',
    handler_paths: ['app/api/exec/learn/route.ts'],
    required_imports: ['@/lib/brain'],
    prohibited_imports: ['@anthropic-ai/sdk'],
    required_calls: ['think(', 'record('],
  ...
  },
  {
    ...
    category: 'ai',
    handler_paths: ['app/api/courses/generate/route.ts', 'app/api/course-builder/chat/route.ts'],
    required_imports: ['@/lib/brain'],
    prohibited_imports: ['@anthropic-ai/sdk'],
    required_calls: ['think(', 'record('],
  ...
  },
  {
    ...
    category: 'ai',
    handler_paths: ['app/api/hipaa/scan/route.ts'],
    required_imports: ['@/lib/brain'],
    prohibited_imports: ['@anthropic-ai/sdk'],
    required_calls: ['think(', 'record('],
  ...
  },
  {
    ...
    category: 'ai',
    handler_paths: ['app/api/cro9-engine/scan/route.ts'],
    required_imports: ['@/lib/brain'],
    prohibited_imports: ['@anthropic-ai/sdk'],
    required_calls: ['think(', 'record('],
  ...
  },
  {
    ...
    category: 'ai',
    handler_paths: ['app/api/brand/generate/route.ts'],
    required_imports: ['@/lib/brain'],
    prohibited_imports: ['@anthropic-ai/sdk'],
    required_calls: ['think(', 'record('],
  ...
  },
  {
    ...
    category: 'ai',
    handler_paths: ['app/api/voice/respond/route.ts'],
    required_imports: ['@/lib/brain'],
    prohibited_imports: ['@anthropic-ai/sdk'],
    required_calls: ['think(', 'record('],
